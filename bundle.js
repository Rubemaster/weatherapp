...
For more info, visit https://fb.me/react-mock-scheduler`);
  ...
  class WeatherResult extends react.Component {
    ...
    render() {
      ...
      if (!weatherData)
        return react.default.createElement("h1", null, "Loading.");
      return react.default.createElement("div", null, JSON.stringify(weatherData));
    }
  }
  class WeatherDisplay extends react.Component {
    ...
    render() {
      ...
      return react.default.createElement("div", null, react.default.createElement("h1", null, "Hello, ", PLACES[activePlace].zip), PLACES.map((place, index) => react.default.createElement("button", {
        key: index,
        onClick: () => {
          console.log("Clicked index" + index);
          this.setState({activePlace: index});
        }
      }, place.name)), react.default.createElement(WeatherResult, {
        zip: PLACES[activePlace].zip
      }));
    }
  }
  ReactDOM.render(react.default.createElement("div", {
    className: "App"
  }, react.default.createElement("header", {
    className: "App-header"
  }, react.default.createElement(WeatherDisplay, null), react.default.createElement("h3", null, " React on Repl.it! "), react.default.createElement("p", null, "Edit ", react.default.createElement("code", null, "wut wut src/App.js"), " to get started!"))), document.getElementById("root"));
})();
